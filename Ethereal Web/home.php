        ...
        <div class="container">
            ...
            <nav>
                ...
                <ul class="navbarMenu">
                    ...
                    <li class="navbar"><a href="home.php" class="navbarLink">Home</a></li>
            ...
            <main>
                ...
                <div class="rightContent">
                    ...
                    <form action="finalMemberForm.php" method="POST">
                        ...
                        <input type="radio" id="premium" name="memberType" value="Premium" checked="checked">
                        <label for="memberType">Premium Member</label><br>
                        <input type="radio" id="standard" name="memberType" value="Standard">
                        <label for="memberType">Standard Member</label><br>

                        <label for="subscription" class="optionPrice">Subscription</label><br>
                        <select name="subscription">

                            <option name="subscription" value="0$">0$</option>
                            <option name="subscription" value="2$ (1 Month)">2$ (1 Month)</option>
                            <option name="subscription" value="5$ (5 Month)">5$ (5 Month)</option>
                            <option name="subscription" value="8$ (8 Month)">8$ (8 Month)</option>
                            <option name="subscription" value="15$ (1 Year)">15$ (1 Year)</option>

                        </select><br>

                        <label for="comment">Helpful Comment</label><br>
                        <textarea name="comment" placeholder="You should improve this website by..."></textarea><br>
